...
if (hasLanguageIndicator && !fs.existsSync(detectionCachePath)) {
  issues.push('.a365-workspace-detection.local.json was not written — Phase 0A Step 1 triage was skipped. The skill must run a365-setup (which writes this cache) before any Phase 1 work. Re-run /a365-setup, then re-run /make-ai-teammate');
}

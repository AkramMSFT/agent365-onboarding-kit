...
hooks:
  ...
  stop:
    - type: command
      command: node "${CLAUDE_PROJECT_DIR}/.a365-kit/hooks/stop/validate-a365-code-validator.js"
      timeout: 15000
    - type: prompt
      prompt: |
...
```text
.a365-kit/skills/a365-code-validator/references/validation-checklist.md
```

...
**Full instructions:** [.a365-kit/skills/a365-setup/SKILL.md](../.a365-kit/skills/a365-setup/SKILL.md)
...
**Full instructions:** [.a365-kit/skills/make-ai-teammate/SKILL.md](../.a365-kit/skills/make-ai-teammate/SKILL.md)
...
9. Offers `add-workiq-tools` as optional when `has_workiq = false` — asks the user; can be run later via `/add-workiq-tools`. **Skipped when `has_workiq = true`** (already wired).

**Reference patterns:**
- Node.js: [.a365-kit/skills/make-ai-teammate/references/nodejs-ai-teammate.md](../.a365-kit/skills/make-ai-teammate/references/nodejs-ai-teammate.md)
- Node.js notifications: [.a365-kit/skills/make-ai-teammate/references/nodejs-notifications.md](../.a365-kit/skills/make-ai-teammate/references/nodejs-notifications.md)
- .NET: [.a365-kit/skills/make-ai-teammate/references/dotnet-ai-teammate.md](../.a365-kit/skills/make-ai-teammate/references/dotnet-ai-teammate.md)
- Python: [.a365-kit/skills/make-ai-teammate/references/python-ai-teammate.md](../.a365-kit/skills/make-ai-teammate/references/python-ai-teammate.md)

---

## Skill: make-a365-agent

**Full instructions:** [.a365-kit/skills/make-a365-agent/SKILL.md](../.a365-kit/skills/make-a365-agent/SKILL.md)
...
**Full instructions:** [.a365-kit/skills/add-workiq-tools/SKILL.md](../.a365-kit/skills/add-workiq-tools/SKILL.md)
...
**Reference patterns:**
- .NET: [.a365-kit/skills/add-workiq-tools/references/dotnet-workiq.md](../.a365-kit/skills/add-workiq-tools/references/dotnet-workiq.md)
- Node.js: [.a365-kit/skills/add-workiq-tools/references/nodejs-workiq.md](../.a365-kit/skills/add-workiq-tools/references/nodejs-workiq.md)
- Python: [.a365-kit/skills/add-workiq-tools/references/python-workiq.md](../.a365-kit/skills/add-workiq-tools/references/python-workiq.md)

---

## Skill: instrument-observability

**Full instructions:** [.a365-kit/skills/instrument-observability/SKILL.md](../.a365-kit/skills/instrument-observability/SKILL.md)
...
**Reference patterns:**
- .NET: [.a365-kit/skills/instrument-observability/references/dotnet-observability.md](../.a365-kit/skills/instrument-observability/references/dotnet-observability.md)
- Node.js: [.a365-kit/skills/instrument-observability/references/nodejs-observability.md](../.a365-kit/skills/instrument-observability/references/nodejs-observability.md)
- Python: [.a365-kit/skills/instrument-observability/references/python-observability.md](../.a365-kit/skills/instrument-observability/references/python-observability.md)

---

## Skill: a365-code-validator

**Full instructions:** [.a365-kit/skills/a365-code-validator/SKILL.md](../.a365-kit/skills/a365-code-validator/SKILL.md)
...
**Reference checklist:**
- [.a365-kit/skills/a365-code-validator/references/validation-checklist.md](../.a365-kit/skills/a365-code-validator/references/validation-checklist.md)

---

## Skill: purview-dlp-integration

**Full instructions:** [.a365-kit/skills/purview-dlp-integration/SKILL.md](../.a365-kit/skills/purview-dlp-integration/SKILL.md)
...
2. Detects the language and authentication: delegated Node.js uses `assets/purview.ts`, Python uses `assets/purview.py`, and .NET uses `assets/purview.cs` (best-effort port). Node.js client-secret FMI S2S uses `assets/purview-s2s.ts`; do not switch managed-identity-only agents to it.
3. Copies ONE generic, env-driven guard file into the agent source (no edits needed).
4. Wires an **INPUT gate** before the LLM and optional **output auditing** before the reply. The supplied policy blocks `UploadText`, not sensitive responses; a failed audit withholds the reply in fail-closed mode. Delegated guards use the agent's own auth handler at `/me`; S2S uses the agent identity FMI token at `/users/{sponsor}/...`. Python's snippet returns text for its caller to send; host callbacks must send block/withhold activities explicitly.
5. Adds missing env keys without duplicating existing values: Node.js/Python use `.env`; .NET uses the process environment or selected `launchSettings.json` profile. Delegated guards auto-read IDs from a365 config; S2S requires the existing canonical `AGENT365_*` credentials and `PURVIEW_SPONSOR_USER_ID`.
6. Delegated: `scripts/Grant-DelegatedGraphScope.ps1` **appends** `Content.Process.User`. Node.js S2S: `scripts/Grant-ContentProcessAppRole.ps1` grants `Content.Process.All` to the agent identity SP. Never run `az ad app permission admin-consent` on the blueprint app.
...
**Non-negotiable constraints:** agentic delegated token + `/me`, or agent identity FMI token + `/users/{sponsor}/...` for Node.js S2S (never a blueprint app-only token); `contentEntry.name` always set + `processingErrors` fail-closed by default; dedicated AI-app policy; input blocking, output audit only; never `admin-consent` the blueprint app; trust the `[purview]` log, not `DistributionStatus`.
...
**Prerequisite:** supported agentic delegated hosting or Node.js client-secret FMI authentication. Manual IDs replace config auto-discovery, not missing authentication. Stop before editing a plain bot without a supported path and route to `a365-setup`.

**Reference patterns:**
- Guards + wiring: [.a365-kit/skills/purview-dlp-integration/assets/purview.ts](../.a365-kit/skills/purview-dlp-integration/assets/purview.ts) · [purview.py](../.a365-kit/skills/purview-dlp-integration/assets/purview.py) · [purview.cs](../.a365-kit/skills/purview-dlp-integration/assets/purview.cs) · [purview-s2s.ts](../.a365-kit/skills/purview-dlp-integration/assets/purview-s2s.ts)
- Portal / tenant enablement: [.a365-kit/skills/purview-dlp-integration/references/purview-portal-guide.md](../.a365-kit/skills/purview-dlp-integration/references/purview-portal-guide.md)
- Troubleshooting: [.a365-kit/skills/purview-dlp-integration/references/troubleshooting.md](../.a365-kit/skills/purview-dlp-integration/references/troubleshooting.md)

---

## Skill: test-local

**Full instructions:** [.a365-kit/skills/test-local/SKILL.md](../.a365-kit/skills/test-local/SKILL.md)
...
2. Checks `agentsplayground` CLI (npm package `@microsoft/m365agentsplayground`) is installed — installs automatically if missing
...
[.a365-kit/shared/agent-detection.md](../.a365-kit/shared/agent-detection.md)

Key rules:
- `.csproj` referencing `Microsoft.Agents.AI` → **.NET AgentFramework**; common hosting/notification packages do not identify the LLM framework.
...
- `.py` files + `pyproject.toml` or `requirements.txt` referencing `agent-framework`, `agent-framework-core`, or its actual integration → **Python AgentFramework**; common `microsoft-agents-hosting-*` packages do not identify the LLM framework.
